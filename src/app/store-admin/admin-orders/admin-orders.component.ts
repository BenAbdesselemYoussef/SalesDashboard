...
import { ValidateDileveryDialogComponent } from '../validate-dilevery-dialog/validate-dilevery-dialog.component';
...
export class AdminOrdersComponent implements OnInit {
  ...
  openValidateOrderDialog(order:any){
    this.dialog.open(ValidateDileveryDialogComponent,{
      width: '700px',
      data: { 
        order:order
      }
